 ...
 * Comprehensive validation of the build process and output
 */
...
function validateTests() {
	console.log('\n🧪 Running unit tests...');
	return runCommand('npm run test', 'Unit tests');
}
...
function main() {
	...
	if (allPassed) {
		console.log('🎉 All validations passed! Build is ready for distribution.');
		process.exit(0);
	} else {
		console.log('💥 Some validations failed. Please fix the issues before proceeding.');
		process.exit(1);
	}
}
